...
<section id="mk-footer-unfold-spacer">
  ...
  <!--WFC EDIT ADD CUSTOM SIDEBAR FOR EVERY PAGE HERE-->

  <div class="footer-wrapper fullwidth-footer wfc-top-footer-bar">

    <div class="mk-padding-wrapper">

      <div class="mk-col-1-1">

        <!--SET THIS ISH TO BE FULL WIDTH-->

        <?php dynamic_sidebar('footer_top_sidebar'); ?>
